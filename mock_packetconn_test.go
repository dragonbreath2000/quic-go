...
//
//	mockgen -typed -package quic -self_package github.com/dragonbreath2000/quic-go -self_package github.com/dragonbreath2000/quic-go -destination mock_packetconn_test.go net PacketConn
//
